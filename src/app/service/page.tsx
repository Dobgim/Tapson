...
export const metadata: Metadata = {
  ...
  description:
    "Factory-certified powersports and marine service in South Florida. Maintenance, diagnostics, repowers and warranty work on Yamaha, Sea-Doo, Can-Am, Polaris and more.",
...
const capabilities = [
  ...
  { Icon: Anchor, title: "Marine rigging & repowers", body: "Outboard installs, controls, electronics and full repowers out of Key Largo." },
          ...
          <div>
            <Reveal>
              ...
              <p className="mt-5 text-base leading-relaxed text-white/60">
                Our Key Largo store is a full marine facility — outboard installs, electronics,
            ...
            <Reveal delay={0.12} className="mt-8 flex flex-wrap gap-3">
              ...
              <ButtonLink href={`/locations#${locations[1].id}`} variant="light" size="lg">
                Key Largo store
              </ButtonLink>
            </Reveal>
          </div>
