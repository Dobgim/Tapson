...
const timeline = [
  { year: "2005", title: "One store, one department", body: "We opened selling watercraft and outboards out of a single building in south Miami-Dade." },
  { year: "2011", title: "The Keys store opens", body: "Key Largo gave us water access, which turned the marine side from a counter into a full department." },
  ...
  { year: "2021", title: "Pompano Beach", body: "A third store took us into Broward and let us hold real depth on watercraft through the season." },
...
const reviews = [
  {
    ...
    name: "Marcus D.",
    detail: "Sea-Doo RXT-X · Pompano Beach",
  },
  {
  ...
  },
  {
    ...
    name: "Tony V.",
    detail: "Polaris RANGER · Key Largo",
  },
];
