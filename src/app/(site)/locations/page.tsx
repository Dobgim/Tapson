...
export const metadata: Metadata = {
  ...
  description:
    "Repossessed Rides store location, opening hours, phone number and directions for Burlington, Vermont.",
  ...
  return (
    <>
      <PageHero
        ...
        body="Every unit we sell is prepped and collected from our Burlington store."
