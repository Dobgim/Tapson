...
export async function generateMetadata({
  ...
  const title = category ? `${category.name} for sale in Vermont` : "Inventory";
  const description = category
    ? `${category.blurb} Browse ${category.name.toLowerCase()} in stock at Repossessed Rides in Burlington, Vermont.`
    : "Filter every new and pre-owned unit in stock by make, model, price and condition.";
